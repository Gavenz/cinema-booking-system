...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    /* make the close button a tidy ghost chip */
        ...
        <article class="card" data-id="${m.id}">
          ...
          <div class="card-body">
            ...
            <div class="card-actions">
              ...
              <a class="btn btn-pill btn-tix" href="pages/movie.php?id=${m.id}" aria-label="Buy tickets for ${m.title}">
                <span class="dot" aria-hidden="true"></span> Buy&nbsp;Tix
              </a>
            </div>
